...
cmake -G "Visual Studio 16 2019" -DLLVM_TARGETS_TO_BUILD=X86 -DLATINO_INCLUDE_TESTS=ON `
...
# [System.Diagnostics.Process]::Start("$vs_path\MSBuild\Current\Bin\MSBuild.exe", "$directorio_actual\build\latino.sln")
Start-Process -FilePath "$vs_path\MSBuild\Current\Bin\MSBuild.exe" -ArgumentList "latino.sln /t:Build /p:Configuration=Debug" -NoNewWindow
