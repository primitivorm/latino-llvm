...
void latino::EmitClangDiagsDefs(RecordKeeper &Records, raw_ostream &OS,
...
void latino::EmitClangDiagGroups(RecordKeeper &Records, raw_ostream &OS) {
...
void latino::EmitClangDiagsIndexName(RecordKeeper &Records, raw_ostream &OS) {
  const std::vector<Record*> &Diags =
    Records.getAllDerivedDefinitions("Diagnostic");
...
void latino::EmitClangDiagDocs(RecordKeeper &Records, raw_ostream &OS) {
