...
void latino::EmitClangCommentCommandInfo(RecordKeeper &Records, raw_ostream &OS) {
...
void latino::EmitClangCommentCommandList(RecordKeeper &Records, raw_ostream &OS) {
  emitSourceFileHeader("A list of commands useable in documentation "
                       "comments", OS);
