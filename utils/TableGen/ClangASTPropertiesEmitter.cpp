...
void latino::EmitClangTypeReader(RecordKeeper &records, raw_ostream &out) {
...
void latino::EmitClangTypeWriter(RecordKeeper &records, raw_ostream &out) {
...
/// basic values.
void latino::EmitClangBasicReader(RecordKeeper &records, raw_ostream &out) {
...
/// basic values.
void latino::EmitClangBasicWriter(RecordKeeper &records, raw_ostream &out) {
