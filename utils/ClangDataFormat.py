...
(lldb) p Tok.Loc
(latino::SourceLocation) $4 = "/usr/include/i386/_types.h:37:1" (offset: 123582, file, local)
"""

import lldb

def __lldb_init_module(debugger, internal_dict):
	debugger.HandleCommand("type summary add -F ClangDataFormat.SourceLocation_summary latino::SourceLocation")
	debugger.HandleCommand("type summary add -F ClangDataFormat.QualType_summary latino::QualType")
...
class SourceLocation(object):
	...
	def summary(self):
		if self.isInvalid():
			return "<invalid loc>"
		srcmgr_path = findObjectExpressionPath("latino::SourceManager", self.frame)
		if srcmgr_path:
