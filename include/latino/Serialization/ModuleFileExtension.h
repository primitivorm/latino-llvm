...
#ifndef LLVM_LATINO_SERIALIZATION_MODULEFILEEXTENSION_H
#define LLVM_LATINO_SERIALIZATION_MODULEFILEEXTENSION_H
...
#endif // LLVM_LATINO_FRONTEND_MODULEFILEEXTENSION_H
