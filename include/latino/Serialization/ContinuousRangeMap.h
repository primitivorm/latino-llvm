...
#ifndef LLVM_LATINO_SERIALIZATION_CONTINUOUSRANGEMAP_H
#define LLVM_LATINO_SERIALIZATION_CONTINUOUSRANGEMAP_H
...
#endif // LLVM_LATINO_SERIALIZATION_CONTINUOUSRANGEMAP_H
