...
#ifndef LLVM_LATINO_SERIALIZATION_INMEMORYMODULECACHE_H
#define LLVM_LATINO_SERIALIZATION_INMEMORYMODULECACHE_H
...
#endif // LLVM_LATINO_SERIALIZATION_INMEMORYMODULECACHE_H
