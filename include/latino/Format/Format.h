...
#ifndef LLVM_LATINO_FORMAT_FORMAT_H
#define LLVM_LATINO_FORMAT_FORMAT_H

#include "latino/Basic/LangOptions.h"
#include "latino/Tooling/Core/Replacement.h"
#include "latino/Tooling/Inclusions/IncludeStyle.h"
...
namespace std {
template <>
struct is_error_code_enum<latino::format::ParseError> : std::true_type {};
} // namespace std

#endif // LLVM_LATINO_FORMAT_FORMAT_H
