...
//===----------------------------------------------------------------------===//
#ifndef LLVM_LATINO_TOOLING_SYNTAX_NODES_H
#define LLVM_LATINO_TOOLING_SYNTAX_NODES_H
...
/// correspond 1-to-1 to latino::Decl. Syntax trees distinguish between top-level
