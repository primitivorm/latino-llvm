...
#ifndef LLVM_LATINO_TOOLING_SYNTAX_TOKENS_H
#define LLVM_LATINO_TOOLING_SYNTAX_TOKENS_H
...
public:
  ...
  /// EXPECTS: latino::Token is not an annotation token.
  explicit Token(const latino::Token &T);
