...
#ifndef LLVM_LATINO_TOOLING_TOOLING_H
#define LLVM_LATINO_TOOLING_TOOLING_H
...
/// Interface to process a latino::CompilerInvocation.
///
...
/// Interface to generate latino::FrontendActions.
///
...
public:
  ...
  /// Returns a new latino::FrontendAction.
  virtual std::unique_ptr<FrontendAction> create() = 0;
};

/// Returns a new FrontendActionFactory for a given type.
///
/// T must derive from latino::FrontendAction.
///
/// Example:
/// FrontendActionFactory *Factory =
///   newFrontendActionFactory<latino::SyntaxOnlyAction>();
template <typename T>
...
public:
  ...
  /// \see latino::FrontendAction::BeginSourceFileAction
  virtual bool handleBeginSource(CompilerInstance &CI) {
    return true;
  }

  /// Called after a source file is processed by a FrontendAction.
  /// \see latino::FrontendAction::EndSourceFileAction
...
///   latino::ASTConsumer *newASTConsumer();
/// } Factory;
...
#endif // LLVM_LATINO_TOOLING_TOOLING_H
