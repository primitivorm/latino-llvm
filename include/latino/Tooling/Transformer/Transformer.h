...
#ifndef LLVM_LATINO_TOOLING_TRANSFORMER_TRANSFORMER_H_
#define LLVM_LATINO_TOOLING_TRANSFORMER_TRANSFORMER_H_

#include "latino/ASTMatchers/ASTMatchFinder.h"
#include "latino/Tooling/Refactoring/AtomicChange.h"
#include "latino/Tooling/Transformer/RewriteRule.h"
...
public:
  using ChangeConsumer =
      std::function<void(Expected<latino::tooling::AtomicChange> Change)>;
...
#endif // LLVM_LATINO_TOOLING_TRANSFORMER_TRANSFORMER_H_
