...
#ifndef LLVM_LATINO_TOOLING_TRANSFORMER_MATCH_CONSUMER_H_
#define LLVM_LATINO_TOOLING_TRANSFORMER_MATCH_CONSUMER_H_
...
#endif // LLVM_LATINO_TOOLING_TRANSFORMER_MATCH_CONSUMER_H_
