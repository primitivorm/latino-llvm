...
#ifndef LLVM_LATINO_TOOLING_INCLUSIONS_INCLUDESTYLE_H
#define LLVM_LATINO_TOOLING_INCLUSIONS_INCLUDESTYLE_H
...
LLVM_YAML_IS_SEQUENCE_VECTOR(latino::tooling::IncludeStyle::IncludeCategory)

namespace llvm {
namespace yaml {

template <>
struct MappingTraits<latino::tooling::IncludeStyle::IncludeCategory> {
  static void mapping(IO &IO,
                      latino::tooling::IncludeStyle::IncludeCategory &Category);
};

template <>
struct ScalarEnumerationTraits<
    latino::tooling::IncludeStyle::IncludeBlocksStyle> {
  static void
  enumeration(IO &IO, latino::tooling::IncludeStyle::IncludeBlocksStyle &Value);
};

} // namespace yaml
} // namespace llvm

#endif // LLVM_LATINO_TOOLING_INCLUSIONS_INCLUDESTYLE_H
