...
#ifndef LLVM_LATINO_TOOLING_REFACTOR_EXTRACT_EXTRACT_H
#define LLVM_LATINO_TOOLING_REFACTOR_EXTRACT_EXTRACT_H
...
#endif // LLVM_LATINO_TOOLING_REFACTOR_EXTRACT_EXTRACT_H
