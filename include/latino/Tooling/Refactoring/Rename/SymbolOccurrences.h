...
#ifndef LLVM_LATINO_TOOLING_REFACTOR_RENAME_SYMBOL_OCCURRENCES_H
#define LLVM_LATINO_TOOLING_REFACTOR_RENAME_SYMBOL_OCCURRENCES_H
...
#endif // LLVM_LATINO_TOOLING_REFACTOR_RENAME_SYMBOL_OCCURRENCES_H
