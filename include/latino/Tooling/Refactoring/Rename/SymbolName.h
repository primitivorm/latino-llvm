...
#ifndef LLVM_LATINO_TOOLING_REFACTOR_RENAME_SYMBOL_NAME_H
#define LLVM_LATINO_TOOLING_REFACTOR_RENAME_SYMBOL_NAME_H
...
#endif // LLVM_LATINO_TOOLING_REFACTOR_RENAME_SYMBOL_NAME_H
