...
#ifndef LLVM_LATINO_TOOLING_REFACTOR_RENAME_USR_FINDING_ACTION_H
#define LLVM_LATINO_TOOLING_REFACTOR_RENAME_USR_FINDING_ACTION_H
...
#endif // LLVM_LATINO_TOOLING_REFACTOR_RENAME_USR_FINDING_ACTION_H
