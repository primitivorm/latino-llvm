...
#ifndef LLVM_LATINO_TOOLING_REFACTOR_REFACTORING_OPTION_H
#define LLVM_LATINO_TOOLING_REFACTOR_REFACTORING_OPTION_H
...
#endif // LLVM_LATINO_TOOLING_REFACTOR_REFACTORING_OPTION_H
