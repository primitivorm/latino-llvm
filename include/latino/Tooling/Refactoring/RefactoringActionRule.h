...
#ifndef LLVM_LATINO_TOOLING_REFACTOR_REFACTORING_ACTION_RULE_H
#define LLVM_LATINO_TOOLING_REFACTOR_REFACTORING_ACTION_RULE_H
...
#endif // LLVM_LATINO_TOOLING_REFACTOR_REFACTORING_ACTION_RULE_H
