...
//===----------------------------------------------------------------------===//
//
//  This file defines the latino::ParseAST method.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LATINO_PARSE_PARSEAST_H
#define LLVM_LATINO_PARSE_PARSEAST_H
...
namespace latino {
  ...
  void ParseAST(latino::Preprocessor &PP, latino::ASTConsumer *C,
                latino::ASTContext &Ctx, bool PrintStats = false,
                clang::TranslationUnitKind TUKind = clang::TU_Complete,
                latino::CodeCompleteConsumer *CompletionConsumer = nullptr,
