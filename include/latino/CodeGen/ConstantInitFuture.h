...
#ifndef LLVM_LATINO_CODEGEN_CONSTANTINITFUTURE_H
#define LLVM_LATINO_CODEGEN_CONSTANTINITFUTURE_H
...
namespace llvm {
template <>
struct PointerLikeTypeTraits< ::latino::CodeGen::ConstantInitBuilderBase*> {
  using T = ::latino::CodeGen::ConstantInitBuilderBase*;
...
template <>
struct PointerLikeTypeTraits< ::latino::CodeGen::ConstantInitFuture> {
  using T = ::latino::CodeGen::ConstantInitFuture;
