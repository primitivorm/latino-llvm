...
#ifndef LLVM_LATINO_DRIVER_TYPES_H
#define LLVM_LATINO_DRIVER_TYPES_H
...
#include "latino/Driver/Types.def"
#undef TYPE
    TY_LAST
  };
  ...
  llvm::SmallVector<phases::ID, phases::MaxNumberOfPhases>
  getCompilationPhases(const latino::driver::Driver &Driver,
