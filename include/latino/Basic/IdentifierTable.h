...
template<>
struct PointerLikeTypeTraits<latino::IdentifierInfo*> {
  static void *getAsVoidPointer(latino::IdentifierInfo* P) {
    return P;
  }
...
template<>
struct PointerLikeTypeTraits<const latino::IdentifierInfo*> {
...
#endif // LLVM_LATINO_BASIC_IDENTIFIERTABLE_H
