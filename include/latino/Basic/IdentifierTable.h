...
public:
  ...
  */
  ...
  void setFETokenInfoChangeSinceDeserealization() {
...
class Selector {
  ...
  Selector(IdentifierInfo *II, unsigned nArgs) {
    ...
    assert((InfoPtr & ArgFlags) == 0 && "Insuficiently aligned IdentifierInfo");
...
public:
  ...
  /// name was supplied.
  StringRef getnameForSlot() const;
  ...
  static Selector getEmptyMarker() { return getStringFormatFamilyImpl(*this); }
