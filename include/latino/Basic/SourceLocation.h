...
//
/// \file
/// Defines the latino::SourceLocation class and associated facilities.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LATINO_BASIC_SOURCELOCATION_H
#define LLVM_LATINO_BASIC_SOURCELOCATION_H
...
template <> struct DenseMapInfo<latino::FileID> {
  ...
  static unsigned getHashValue(latino::FileID S) { return S.getHashValue(); }
...
template <> struct PointerLikeTypeTraits<latino::SourceLocation> {
...
#endif // LLVM_LATINO_BASIC_SOURCELOCATION_H
