...
#ifndef LLVM_LATINO_BASIC_TARGETBUILTINS_H
#define LLVM_LATINO_BASIC_TARGETBUILTINS_H
...
namespace latino {
  ...
  namespace NEON {
  enum {
    LastTIBuiltin = latino::Builtin::FirstTSBuiltin - 1,
#define BUILTIN(ID, TYPE, ATTRS) BI##ID,
#include "latino/Basic/BuiltinsNEON.def"
    FirstTSBuiltin
  };
  }
...
#define BUILTIN(ID, TYPE, ATTRS) BI##ID,
#include "latino/Basic/BuiltinsARM.def"
      LastTSBuiltin
    };
  }
  ...
  enum {
    LastNEONBuiltin = NEON::FirstTSBuiltin - 1,
#define BUILTIN(ID, TYPE, ATTRS) BI##ID,
#include "latino/Basic/BuiltinsSVE.def"
    FirstTSBuiltin,
  };
  }
  ...
  #define BUILTIN(ID, TYPE, ATTRS) BI##ID,
  #include "latino/Basic/BuiltinsAArch64.def"
    LastTSBuiltin
  };
  }
  ...
  namespace PPC {
    enum {
        LastTIBuiltin = latino::Builtin::FirstTSBuiltin-1,
#define BUILTIN(ID, TYPE, ATTRS) BI##ID,
#include "latino/Basic/BuiltinsPPC.def"
        LastTSBuiltin
    };
  }
  ...
  namespace NVPTX {
    enum {
        LastTIBuiltin = latino::Builtin::FirstTSBuiltin-1,
#define BUILTIN(ID, TYPE, ATTRS) BI##ID,
#include "latino/Basic/BuiltinsNVPTX.def"
        LastTSBuiltin
    };
  }
  ...
  enum {
    LastTIBuiltin = latino::Builtin::FirstTSBuiltin - 1,
  #define BUILTIN(ID, TYPE, ATTRS) BI##ID,
  #include "latino/Basic/BuiltinsAMDGPU.def"
    LastTSBuiltin
  };
  }
  ...
  enum {
    LastTIBuiltin = latino::Builtin::FirstTSBuiltin - 1,
#define BUILTIN(ID, TYPE, ATTRS) BI##ID,
#include "latino/Basic/BuiltinsX86.def"
    FirstX86_64Builtin,
    LastX86CommonBuiltin = FirstX86_64Builtin - 1,
#define BUILTIN(ID, TYPE, ATTRS) BI##ID,
#include "latino/Basic/BuiltinsX86_64.def"
    LastTSBuiltin
  };
  }
  ...
  /// VE builtins
  namespace VE {
  enum { LastTIBuiltin = latino::Builtin::FirstTSBuiltin - 1, LastTSBuiltin };
  }
...
#undef LLVM_GET_SVE_IMMCHECKTYPES
  ...
  namespace Hexagon {
    enum {
        LastTIBuiltin = latino::Builtin::FirstTSBuiltin-1,
#define BUILTIN(ID, TYPE, ATTRS) BI##ID,
#include "latino/Basic/BuiltinsHexagon.def"
        LastTSBuiltin
    };
  }
  ...
  namespace Mips {
    enum {
        LastTIBuiltin = latino::Builtin::FirstTSBuiltin-1,
#define BUILTIN(ID, TYPE, ATTRS) BI##ID,
#include "latino/Basic/BuiltinsMips.def"
        LastTSBuiltin
    };
  }
...
#include "latino/Basic/BuiltinsXCore.def"
  ...
  namespace SystemZ {
    enum {
        LastTIBuiltin = latino::Builtin::FirstTSBuiltin-1,
#define BUILTIN(ID, TYPE, ATTRS) BI##ID,
#include "latino/Basic/BuiltinsSystemZ.def"
        LastTSBuiltin
    };
  }
  ...
  namespace WebAssembly {
    enum {
      LastTIBuiltin = latino::Builtin::FirstTSBuiltin-1,
#define BUILTIN(ID, TYPE, ATTRS) BI##ID,
#include "latino/Basic/BuiltinsWebAssembly.def"
      LastTSBuiltin
    };
  }
