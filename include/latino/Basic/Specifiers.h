#ifndef LATINO_BASIC_SPECIFIERS_H
#define LATINO_BASIC_SPECIFIERS_H
...
enum TypeSpecifierWidth { TSW_unspecifier, TSW_short, TSW_long, TSW_longlong };

/// Specifies the signedness of a type, e.g., signed or unsigned
enum TypeSpecifierSign { TSS_unspecified, TSS_signed, TSS_unsigned };

enum TypeSpecifierPipe { TSP_unspecified, TSP_pipe };
...
inline bool
isTemplateInstantiationSpecialization(TemplateSpecializationKind Kind) {
  switch (Kind) {
...
#endif /* LATINO_BASIC_SPECIFIERS_H */
