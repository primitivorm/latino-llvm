...
///
//===----------------------------------------------------------------------===//
#ifndef LLVM_LATINO_BASIC_EXCEPTIONSPECIFICATIONTYPE_H
#define LLVM_LATINO_BASIC_EXCEPTIONSPECIFICATIONTYPE_H
...
#endif // LLVM_LATINO_BASIC_EXCEPTIONSPECIFICATIONTYPE_H
