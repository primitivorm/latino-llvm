...
#ifndef LLVM_LATINO_BASIC_SOURCEMANAGER_H
#define LLVM_LATINO_BASIC_SOURCEMANAGER_H
...
public:
  ...
  ContentCache(const ContentCache &RHS)
      : Buffer(nullptr, false), BufferOverridden(false), IsFileVolatile(false),
        IsTransient(false) {
  ...
  const llvm::MemoryBuffer *getBuffer(DiagnosticsEngine &Diag, FileManager &FM,
...
#endif // LLVM_LATINO_BASIC_SOURCEMANAGER_H
