...
//
/// \file
/// Defines implementation details of the latino::SourceManager class.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LATINO_BASIC_SOURCEMANAGERINTERNALS_H
#define LLVM_LATINO_BASIC_SOURCEMANAGERINTERNALS_H
...
#endif // LLVM_LATINO_BASIC_SOURCEMANAGERINTERNALS_H
