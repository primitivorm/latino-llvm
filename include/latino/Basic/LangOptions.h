#ifndef LATINO_BASIC_LANGOPTIONS_H
#define LATINO_BASIC_LANGOPTIONS_H
...
#include "latino/Basic/LangOptions.def"
  ...
  */
  ...
  bool allowNonTrivialObjCLifetimeQualifiers() const {
    return ObjCAutoRefCount || ObjCWeak;
  }

  bool assumeFunctionAreConvergent() const {
