...
#ifndef LLVM_LATINO_ASTMATCHERS_DYNAMIC_DIAGNOSTICS_H
#define LLVM_LATINO_ASTMATCHERS_DYNAMIC_DIAGNOSTICS_H
...
#endif  // LLVM_LATINO_AST_MATCHERS_DYNAMIC_DIAGNOSTICS_H
