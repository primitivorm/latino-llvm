...
#ifndef LLVM_LATINO_ASTMATCHERS_DYNAMIC_VARIANTVALUE_H
#define LLVM_LATINO_ASTMATCHERS_DYNAMIC_VARIANTVALUE_H
...
#endif  // LLVM_LATINO_AST_MATCHERS_DYNAMIC_VARIANT_VALUE_H
