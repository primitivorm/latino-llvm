...
#ifndef LLVM_LATINO_ASTMATCHERS_ASTMATCHERS_H
#define LLVM_LATINO_ASTMATCHERS_ASTMATCHERS_H
...
#include "latino/ASTMatchers/ASTMatchersMacros.h"
...
AST_MATCHER_P(ParmVarDecl, isAtPosition, unsigned, N) {
  const latino::DeclContext *Context = Node.getParentFunctionOrMethod();
...
/// \endcode
/// decl(hasAttr(latino::attr::CUDADevice)) matches the function declaration of
...
#endif // LLVM_LATINO_ASTMATCHERS_ASTMATCHERS_H
