...
//  AST_MATCHER_P(latino::MemberExpr, Member,
//                latino::ast_matchers::internal::Matcher<latino::ValueDecl>,
//                InnerMatcher) {
...
#ifndef LLVM_LATINO_ASTMATCHERS_ASTMATCHERSMACROS_H
#define LLVM_LATINO_ASTMATCHERS_ASTMATCHERSMACROS_H
...
#define AST_MATCHER_FUNCTION(ReturnType, DefineMatcher)                        \
  ...
  inline ReturnType DefineMatcher() {                                          \
    return ::latino::ast_matchers::internal::MemoizedMatcher<                   \
...
#define AST_MATCHER(Type, DefineMatcher)                                       \
  ...
  class matcher_##DefineMatcher##Matcher                                       \
      : public ::latino::ast_matchers::internal::MatcherInterface<Type> {       \
  public:                                                                      \
    explicit matcher_##DefineMatcher##Matcher() = default;                     \
    bool matches(const Type &Node,                                             \
                 ::latino::ast_matchers::internal::ASTMatchFinder *Finder,      \
                 ::latino::ast_matchers::internal::BoundNodesTreeBuilder        \
                     *Builder) const override;                                 \
  };                                                                           \
  }                                                                            \
  inline ::latino::ast_matchers::internal::Matcher<Type> DefineMatcher() {      \
    return ::latino::ast_matchers::internal::makeMatcher(                       \
        new internal::matcher_##DefineMatcher##Matcher());                     \
  }                                                                            \
  inline bool internal::matcher_##DefineMatcher##Matcher::matches(             \
      const Type &Node,                                                        \
      ::latino::ast_matchers::internal::ASTMatchFinder *Finder,                 \
      ::latino::ast_matchers::internal::BoundNodesTreeBuilder *Builder) const
...
#define AST_MATCHER_P_OVERLOAD(Type, DefineMatcher, ParamType, Param,          \
  ...
  typedef ::latino::ast_matchers::internal::Matcher<Type> (                     \
...
#define AST_POLYMORPHIC_SUPPORTED_TYPES(...)                                   \
  void(::latino::ast_matchers::internal::TypeList<__VA_ARGS__>)
...
#define AST_POLYMORPHIC_MATCHER(DefineMatcher, ReturnTypesF)                   \
  ...
  class matcher_##DefineMatcher##Matcher                                       \
      : public ::latino::ast_matchers::internal::MatcherInterface<NodeType> {   \
  public:                                                                      \
  ...
  inline ::latino::ast_matchers::internal::PolymorphicMatcherWithParam0<        \
      internal::matcher_##DefineMatcher##Matcher, ReturnTypesF>                \
  DefineMatcher() {                                                            \
    return ::latino::ast_matchers::internal::PolymorphicMatcherWithParam0<      \
        internal::matcher_##DefineMatcher##Matcher, ReturnTypesF>();           \
  }                                                                            \
  template <typename NodeType>                                                 \
...
#define AST_POLYMORPHIC_MATCHER_P_OVERLOAD(DefineMatcher, ReturnTypesF,        \
  ...
  inline ::latino::ast_matchers::internal::PolymorphicMatcherWithParam1<        \
      internal::matcher_##DefineMatcher##OverloadId##Matcher, ParamType,       \
      ReturnTypesF>                                                            \
  DefineMatcher(ParamType Param) {                                             \
    return ::latino::ast_matchers::internal::PolymorphicMatcherWithParam1<      \
        internal::matcher_##DefineMatcher##OverloadId##Matcher, ParamType,     \
        ReturnTypesF>(std::move(Param));                                       \
  }                                                                            \
  typedef ::latino::ast_matchers::internal::PolymorphicMatcherWithParam1<       \
      internal::matcher_##DefineMatcher##OverloadId##Matcher, ParamType,       \
  ...
  bool internal::                                                              \
      matcher_##DefineMatcher##OverloadId##Matcher<NodeType, ParamT>::matches( \
          const NodeType &Node,                                                \
          ::latino::ast_matchers::internal::ASTMatchFinder *Finder,             \
          ::latino::ast_matchers::internal::BoundNodesTreeBuilder *Builder)     \
          const
...
#define AST_POLYMORPHIC_MATCHER_P2_OVERLOAD(DefineMatcher, ReturnTypesF,       \
  ...
  inline ::latino::ast_matchers::internal::PolymorphicMatcherWithParam2<        \
      internal::matcher_##DefineMatcher##OverloadId##Matcher, ParamType1,      \
      ParamType2, ReturnTypesF>                                                \
  DefineMatcher(ParamType1 Param1, ParamType2 Param2) {                        \
    return ::latino::ast_matchers::internal::PolymorphicMatcherWithParam2<      \
        internal::matcher_##DefineMatcher##OverloadId##Matcher, ParamType1,    \
        ParamType2, ReturnTypesF>(std::move(Param1), std::move(Param2));       \
  }                                                                            \
  typedef ::latino::ast_matchers::internal::PolymorphicMatcherWithParam2<       \
      internal::matcher_##DefineMatcher##OverloadId##Matcher, ParamType1,      \
...
#define AST_TYPE_TRAVERSE_MATCHER_DECL(MatcherName, FunctionName,              \
  ...
  extern const ::latino::ast_matchers::internal::                               \
      TypeTraversePolymorphicMatcher<                                          \
          QualType,                                                            \
          ::latino::ast_matchers::internal::TypeMatcher##MatcherName##Getter,   \
          ::latino::ast_matchers::internal::TypeTraverseMatcher,                \
          ReturnTypesF>::Func MatcherName

#define AST_TYPE_TRAVERSE_MATCHER_DEF(MatcherName, ReturnTypesF)               \
  const ::latino::ast_matchers::internal::TypeTraversePolymorphicMatcher<       \
      QualType,                                                                \
      ::latino::ast_matchers::internal::TypeMatcher##MatcherName##Getter,       \
      ::latino::ast_matchers::internal::TypeTraverseMatcher,                    \
      ReturnTypesF>::Func MatcherName
...
#define AST_TYPELOC_TRAVERSE_MATCHER_DECL(MatcherName, FunctionName,           \
  ...
  extern const ::latino::ast_matchers::internal::                               \
      TypeTraversePolymorphicMatcher<                                          \
          TypeLoc,                                                             \
          ::latino::ast_matchers::internal::                                    \
              TypeLocMatcher##MatcherName##Getter,                             \
          ::latino::ast_matchers::internal::TypeLocTraverseMatcher,             \
...
#define AST_TYPELOC_TRAVERSE_MATCHER_DEF(MatcherName, ReturnTypesF)            \
  const ::latino::ast_matchers::internal::TypeTraversePolymorphicMatcher<       \
      TypeLoc,                                                                 \
      ::latino::ast_matchers::internal::TypeLocMatcher##MatcherName##Getter,    \
      ::latino::ast_matchers::internal::TypeLocTraverseMatcher,                 \
      ReturnTypesF>::Func MatcherName##Loc;                                    \
...
#define AST_MATCHER_REGEX_OVERLOAD(Type, DefineMatcher, Param, OverloadId)     \
  ...
  inline ::latino::ast_matchers::internal::Matcher<Type> DefineMatcher(         \
    ...
    return ::latino::ast_matchers::internal::makeMatcher(                       \
        new internal::matcher_##DefineMatcher##OverloadId##Matcher(            \
            ::latino::ast_matchers::internal::createAndVerifyRegex(             \
...
#endif // LLVM_LATINO_ASTMATCHERS_ASTMATCHERSMACROS_H
