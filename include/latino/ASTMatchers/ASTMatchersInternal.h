...
#ifndef LLVM_LATINO_ASTMATCHERS_ASTMATCHERSINTERNAL_H
#define LLVM_LATINO_ASTMATCHERS_ASTMATCHERSINTERNAL_H
...
inline latino::AccessSpecifier getAccessSpecifier(const Decl &Node) {
  return Node.getAccess();
}

inline latino::AccessSpecifier getAccessSpecifier(const CXXBaseSpecifier &Node) {
...
public:
  ...
  virtual llvm::Optional<latino::TraversalKind> TraversalKind() const {
    return llvm::None;
  }
};
...
public:
  ...
  llvm::Optional<latino::TraversalKind> getTraversalKind() const {
...
template <typename T> class TraversalMatcher : public MatcherInterface<T> {
  const DynTypedMatcher InnerMatcher;
  latino::TraversalKind Traversal;

public:
  explicit TraversalMatcher(latino::TraversalKind TK,
                            const Matcher<T> &InnerMatcher)
  ...
  llvm::Optional<latino::TraversalKind> TraversalKind() const override {
    return Traversal;
  }
};
...
#endif // LLVM_LATINO_ASTMATCHERS_ASTMATCHERSINTERNAL_H
