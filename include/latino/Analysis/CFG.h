...
#ifndef LLVM_LATINO_ANALYSIS_CFG_H
#define LLVM_LATINO_ANALYSIS_CFG_H
...
template <> struct simplify_type< ::latino::CFGTerminator> {
  using SimpleType = ::latino::Stmt *;

  static SimpleType getSimplifiedValue(::latino::CFGTerminator Val) {
    return Val.getStmt();
  }
};
...
template <> struct GraphTraits< ::latino::CFGBlock *> {
  using NodeRef = ::latino::CFGBlock *;
  using ChildIteratorType = ::latino::CFGBlock::succ_iterator;

  static NodeRef getEntryNode(::latino::CFGBlock *BB) { return BB; }
  static ChildIteratorType child_begin(NodeRef N) { return N->succ_begin(); }
  static ChildIteratorType child_end(NodeRef N) { return N->succ_end(); }
};

template <> struct GraphTraits<latino::CFGBlock>
    : GraphTraits<latino::CFGBlock *> {};

template <> struct GraphTraits< const ::latino::CFGBlock *> {
  using NodeRef = const ::latino::CFGBlock *;
  using ChildIteratorType = ::latino::CFGBlock::const_succ_iterator;

  static NodeRef getEntryNode(const latino::CFGBlock *BB) { return BB; }
  static ChildIteratorType child_begin(NodeRef N) { return N->succ_begin(); }
  static ChildIteratorType child_end(NodeRef N) { return N->succ_end(); }
};
...
template <> struct GraphTraits<Inverse< ::latino::CFGBlock *>> {
  using NodeRef = ::latino::CFGBlock *;
  using ChildIteratorType = ::latino::CFGBlock::const_pred_iterator;

  static NodeRef getEntryNode(Inverse<::latino::CFGBlock *> G) {
    return G.Graph;
  }
...
template <> struct GraphTraits<Inverse<const ::latino::CFGBlock *>> {
  using NodeRef = const ::latino::CFGBlock *;
  using ChildIteratorType = ::latino::CFGBlock::const_pred_iterator;

  static NodeRef getEntryNode(Inverse<const ::latino::CFGBlock *> G) {
    return G.Graph;
  }
...
template <> struct GraphTraits<const Inverse<latino::CFGBlock>>
    : GraphTraits<latino::CFGBlock *> {};

// Traits for: CFG

template <> struct GraphTraits< ::latino::CFG* >
    : public GraphTraits< ::latino::CFGBlock *>  {
  using nodes_iterator = ::latino::CFG::iterator;

  static NodeRef getEntryNode(::latino::CFG *F) { return &F->getEntry(); }
  static nodes_iterator nodes_begin(::latino::CFG* F) { return F->nodes_begin();}
  static nodes_iterator   nodes_end(::latino::CFG* F) { return F->nodes_end(); }
  static unsigned              size(::latino::CFG* F) { return F->size(); }
};

template <> struct GraphTraits<const ::latino::CFG* >
    : public GraphTraits<const ::latino::CFGBlock *>  {
  using nodes_iterator = ::latino::CFG::const_iterator;

  static NodeRef getEntryNode(const ::latino::CFG *F) { return &F->getEntry(); }

  static nodes_iterator nodes_begin( const ::latino::CFG* F) {
    return F->nodes_begin();
  }

  static nodes_iterator nodes_end( const ::latino::CFG* F) {
    return F->nodes_end();
  }

  static unsigned size(const ::latino::CFG* F) {
    return F->size();
  }
};

template <> struct GraphTraits<Inverse< ::latino::CFG *>>
  : public GraphTraits<Inverse< ::latino::CFGBlock *>> {
  using nodes_iterator = ::latino::CFG::iterator;

  static NodeRef getEntryNode(::latino::CFG *F) { return &F->getExit(); }
  static nodes_iterator nodes_begin( ::latino::CFG* F) {return F->nodes_begin();}
  static nodes_iterator nodes_end( ::latino::CFG* F) { return F->nodes_end(); }
};

template <> struct GraphTraits<Inverse<const ::latino::CFG *>>
  : public GraphTraits<Inverse<const ::latino::CFGBlock *>> {
  using nodes_iterator = ::latino::CFG::const_iterator;

  static NodeRef getEntryNode(const ::latino::CFG *F) { return &F->getExit(); }
...
#endif // LLVM_LATINO_ANALYSIS_CFG_H
