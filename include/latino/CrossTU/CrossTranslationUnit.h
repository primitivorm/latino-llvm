...
//
//===----------------------------------------------------------------------===//
#ifndef LLVM_LATINO_CROSSTU_CROSSTRANSLATIONUNIT_H
#define LLVM_LATINO_CROSSTU_CROSSTRANSLATIONUNIT_H
...
public:
  ...
  getImportedFromSourceLocation(const latino::SourceLocation &ToLoc) const;
...
private:
  ...
  private:
    ...
    using OwningMapTy = BaseMapTy<std::unique_ptr<latino::ASTUnit>>;
    using NonOwningMapTy = BaseMapTy<latino::ASTUnit *>;
...
#endif // LLVM_LATINO_CROSSTU_CROSSTRANSLATIONUNIT_H
