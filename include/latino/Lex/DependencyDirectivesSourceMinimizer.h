...
#ifndef LLVM_LATINO_LEX_DEPENDENCY_DIRECTIVES_SOURCE_MINIMIZER_H
#define LLVM_LATINO_LEX_DEPENDENCY_DIRECTIVES_SOURCE_MINIMIZER_H
...
#endif // LLVM_LATINO_LEX_DEPENDENCY_DIRECTIVES_SOURCE_MINIMIZER_H
