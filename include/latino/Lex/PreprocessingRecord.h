...
#ifndef LLVM_LATINO_LEX_PREPROCESSINGRECORD_H
#define LLVM_LATINO_LEX_PREPROCESSINGRECORD_H
...
void *operator new(size_t bytes, latino::PreprocessingRecord &PR,
                   unsigned alignment = 8) noexcept;

/// Frees memory allocated in a Clang preprocessing record.
void operator delete(void *ptr, latino::PreprocessingRecord &PR,
                     unsigned) noexcept;
...
inline void *operator new(size_t bytes, latino::PreprocessingRecord &PR,
                          unsigned alignment) noexcept {
  return PR.Allocate(bytes, alignment);
}

inline void operator delete(void *ptr, latino::PreprocessingRecord &PR,
                            unsigned) noexcept {
  PR.Deallocate(ptr);
}

#endif // LLVM_LATINO_LEX_PREPROCESSINGRECORD_H
