...
//
//===----------------------------------------------------------------------===//
#ifndef LLVM_LATINO_LEX_PPCONDITIONALDIRECTIVERECORD_H
#define LLVM_LATINO_LEX_PPCONDITIONALDIRECTIVERECORD_H
...
#endif // LLVM_LATINO_LEX_PPCONDITIONALDIRECTIVERECORD_H
