...
//
/// \file
/// Defines the latino::MacroInfo and latino::MacroDirective classes.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LATINO_LEX_MACROINFO_H
#define LLVM_LATINO_LEX_MACROINFO_H
...
#endif // LLVM_LATINO_LEX_MACROINFO_H
