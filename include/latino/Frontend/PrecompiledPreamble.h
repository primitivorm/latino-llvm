...
#ifndef LLVM_LATINO_FRONTEND_PRECOMPILED_PREAMBLE_H
#define LLVM_LATINO_FRONTEND_PRECOMPILED_PREAMBLE_H
...
namespace std {
template <>
struct is_error_code_enum<latino::BuildPreambleError> : std::true_type {};
} // namespace std
