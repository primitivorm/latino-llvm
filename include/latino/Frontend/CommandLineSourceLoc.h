...
#ifndef LLVM_LATINO_FRONTEND_COMMANDLINESOURCELOC_H
#define LLVM_LATINO_FRONTEND_COMMANDLINESOURCELOC_H
...
namespace llvm {
  namespace cl {
    ...
    template<>
    class parser<latino::ParsedSourceLocation> final
      : public basic_parser<latino::ParsedSourceLocation> {
    public:
      inline bool parse(Option &O, StringRef ArgName, StringRef ArgValue,
                 latino::ParsedSourceLocation &Val);
    };

    bool
    parser<latino::ParsedSourceLocation>::
