...
#ifndef LLVM_LATINO_FRONTEND_VERIFYDIAGNOSTICCONSUMER_H
#define LLVM_LATINO_FRONTEND_VERIFYDIAGNOSTICCONSUMER_H
...
#endif // LLVM_LATINO_FRONTEND_VERIFYDIAGNOSTICCONSUMER_H
