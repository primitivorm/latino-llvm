...
#ifndef LLVM_LATINO_FRONTEND_SERIALIZEDDIAGNOSTICREADER_H
#define LLVM_LATINO_FRONTEND_SERIALIZEDDIAGNOSTICREADER_H
...
template <>
struct is_error_code_enum<latino::serialized_diags::SDError> : std::true_type {};

} // namespace std

#endif // LLVM_LATINO_FRONTEND_SERIALIZEDDIAGNOSTICREADER_H
