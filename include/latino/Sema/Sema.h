...
#include "latino/AST/MangleNumberingContext.h"
...
#include "latino/Basic/TemplateKinds.h"
...
template <> struct DenseMapInfo<latino::Sema::FunctionDeclAndLoc> {
  ...
  using FDBaseInfo = DenseMapInfo<latino::CanonicalDeclPtr<latino::FunctionDecl>>;
