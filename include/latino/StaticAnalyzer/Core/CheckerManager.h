...
#ifndef LLVM_LATINO_STATICANALYZER_CORE_CHECKERMANAGER_H
#define LLVM_LATINO_STATICANALYZER_CORE_CHECKERMANAGER_H
...
class CheckerNameRef {
  friend class ::latino::ento::CheckerRegistry;
...
#endif // LLVM_LATINO_STATICANALYZER_CORE_CHECKERMANAGER_H
