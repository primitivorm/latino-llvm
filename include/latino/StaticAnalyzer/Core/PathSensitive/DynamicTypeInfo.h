...
#ifndef LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_DYNAMICTYPEINFO_H
#define LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_DYNAMICTYPEINFO_H
...
#endif // LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_DYNAMICTYPEINFO_H
