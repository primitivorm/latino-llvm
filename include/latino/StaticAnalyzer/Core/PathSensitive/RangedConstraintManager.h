...
#ifndef LLVM_LATINO_LIB_STATICANALYZER_CORE_RANGEDCONSTRAINTMANAGER_H
#define LLVM_LATINO_LIB_STATICANALYZER_CORE_RANGEDCONSTRAINTMANAGER_H
...
#include "latino/StaticAnalyzer/Core/PathSensitive/SimpleConstraintManager.h"
