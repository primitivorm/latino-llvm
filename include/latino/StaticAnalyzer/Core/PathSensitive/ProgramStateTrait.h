...
#ifndef LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_PROGRAMSTATETRAIT_H
#define LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_PROGRAMSTATETRAIT_H
...
namespace ento {
  ...
  /// can deal with.
  #define LATINO_ENTO_PROGRAMSTATE_MAP(Key, Value) llvm::ImmutableMap<Key, Value>
  ...
  #define REGISTER_MAP_WITH_PROGRAMSTATE(Name, Key, Value) \
    REGISTER_TRAIT_WITH_PROGRAMSTATE(Name, \
                                     LATINO_ENTO_PROGRAMSTATE_MAP(Key, Value))
...
#endif // LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_PROGRAMSTATETRAIT_H
