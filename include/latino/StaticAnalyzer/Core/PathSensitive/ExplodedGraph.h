...
#define LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_EXPLODEDGRAPH_H
...
namespace llvm {
  template <> struct GraphTraits<latino::ento::ExplodedGraph *> {
    using GraphTy = latino::ento::ExplodedGraph *;
    using NodeRef = latino::ento::ExplodedNode *;
    using ChildIteratorType = latino::ento::ExplodedNode::succ_iterator;
...
#endif // LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_EXPLODEDGRAPH_H
