...
#ifndef LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_STOREREF_H
#define LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_STOREREF_H
...
#endif // LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_STOREREF_H
