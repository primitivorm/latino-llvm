...
#ifndef LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_SVALS_H
#define LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_SVALS_H
...
inline raw_ostream &operator<<(raw_ostream &os, latino::ento::SVal V) {
  V.dumpToStream(os);
  return os;
}
...
#endif // LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_SVALS_H
