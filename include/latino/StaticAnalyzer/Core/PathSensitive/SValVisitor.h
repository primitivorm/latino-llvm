...
#ifndef LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_SVALVISITOR_H
#define LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_SVALVISITOR_H
...
#include "latino/StaticAnalyzer/Core/PathSensitive/SVals.def"
    case SVal::LocKind:
      switch (V.getSubKind()) {
...
#include "latino/StaticAnalyzer/Core/PathSensitive/Symbols.def"
    }
...
#include "latino/StaticAnalyzer/Core/PathSensitive/Regions.def"
    }
