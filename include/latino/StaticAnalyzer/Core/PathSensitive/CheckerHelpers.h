...
#ifndef LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_CHECKERHELPERS_H
#define LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_CHECKERHELPERS_H
...
std::pair<const latino::VarDecl *, const latino::Expr *>
