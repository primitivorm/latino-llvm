...
#ifndef LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_SMTCONSTRAINTMANAGER_H
#define LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_SMTCONSTRAINTMANAGER_H

#include "latino/Basic/JsonSupport.h"
#include "latino/Basic/TargetInfo.h"
#include "latino/StaticAnalyzer/Core/PathSensitive/RangedConstraintManager.h"
#include "latino/StaticAnalyzer/Core/PathSensitive/SMTConv.h"

typedef llvm::ImmutableSet<
    std::pair<latino::ento::SymbolRef, const llvm::SMTExpr *>>
    ConstraintSMTType;
...
class SMTConstraintManager : public latino::ento::SimpleConstraintManager {
  mutable llvm::SMTSolverRef Solver = llvm::CreateZ3Solver();

public:
  SMTConstraintManager(latino::ento::ExprEngine *EE,
                       latino::ento::SValBuilder &SB)
