...
#ifndef LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_DYNAMICCASTINFO_H
#define LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_DYNAMICCASTINFO_H
...
#endif // LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_DYNAMICCASTINFO_H
