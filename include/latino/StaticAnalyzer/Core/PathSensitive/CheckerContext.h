...
#ifndef LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_CHECKERCONTEXT_H
#define LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_CHECKERCONTEXT_H
...
public:
  ...
  *getNoteTag(std::function<std::string(PathSensitiveBugReport &)> &&Cb,
  ...
  ///
  /// \sa latino::Lexer::getSpelling(), latino::Lexer::getImmediateMacroName().
