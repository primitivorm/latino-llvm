...
#ifndef LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_ENVIRONMENT_H
#define LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_ENVIRONMENT_H
...
#endif // LLVM_LATINO_STATICANALYZER_CORE_PATHSENSITIVE_ENVIRONMENT_H
