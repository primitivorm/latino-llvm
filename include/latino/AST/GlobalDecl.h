...
#ifndef LLVM_LATINO_AST_GLOBALDECL_H
#define LLVM_LATINO_AST_GLOBALDECL_H
...
namespace llvm {
  ...
  template<> struct DenseMapInfo<latino::GlobalDecl> {
    static inline latino::GlobalDecl getEmptyKey() {
      return latino::GlobalDecl();
    }

    static inline latino::GlobalDecl getTombstoneKey() {
      return latino::GlobalDecl::
        getFromOpaquePtr(reinterpret_cast<void*>(-1));
    }

    static unsigned getHashValue(latino::GlobalDecl GD) {
      return DenseMapInfo<void*>::getHashValue(GD.getAsOpaquePtr());
    }

    static bool isEqual(latino::GlobalDecl LHS,
                        latino::GlobalDecl RHS) {
      return LHS == RHS;
    }
  };
...
#endif // LLVM_LATINO_AST_GLOBALDECL_H
