...
#ifndef LLVM_LATINO_AST_DECLCXX_H
#define LLVM_LATINO_AST_DECLCXX_H
...
#include "CXXRecordDeclDefinitionBits.def"
  ...
  //   /// occur within default arguments of function parameters within the
  //   class
  ...
  //       : DefinitionData(D), Dependent(Dependent),
  //       IsGenericLambda(IsGeneric),
  //         CaptureDefault(CaptureDefault), NumCaptures(0),
  //         NumExplicitCaptures(0), HasKnownInternalLinkage(0),
  //         ManglingNumber(0), MethodTyInfo(Info) {
  //     IsLambda = true;
...
public:
  ...
  //                                    TypeSourceInfo *Info, SourceLocation
  //                                    Loc, bool DependentLambda, bool
  //                                    IsGeneric, LambdaCaptureDefault
  //                                    CaptureDefault);
...
//                                 SourceLocation L, DeclarationName N, QualType
//                                 T, TypeSourceInfo *TInfo, SourceLocation
//                                 StartL, IdentifierInfo *Getter,
...
//   /// Get the value of this MSGuidDecl as an APValue. This may fail and
//   return
...
#endif // LLVM_LATINO_AST_DECLCXX_H
