...
#ifndef LLVM_LATINO_AST_OPENMPCLAUSE_H
#define LLVM_LATINO_AST_OPENMPCLAUSE_H
...
#include "latino/AST/StmtIterator.h"
...
public:
  ...
  /// latter uses latino::Expr to store the score/condition while the former is
  /// independent of latino. Thus, expressions and conditions are evaluated in
  /// this method.
...
#endif // LLVM_LATINO_AST_OPENMPCLAUSE_H
