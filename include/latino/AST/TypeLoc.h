...
//
/// \file
/// Defines the latino::TypeLoc interface and its subclasses.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LATINO_AST_TYPELOC_H
#define LLVM_LATINO_AST_TYPELOC_H
...
#endif // LLVM_LATINO_AST_TYPELOC_H
