...
//
/// \file
/// Defines the latino::Expr interface and subclasses for C++ expressions.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LATINO_AST_EXPRCXX_H
#define LLVM_LATINO_AST_EXPRCXX_H
...
public:
  ...
  Create(const ASTContext &Context, QualType T, ExprValueKind VK,
         ...
         const CXXCastPath *Path, SourceLocation LPLoc, SourceLocation RPLoc);
...
#endif // LLVM_LATINO_AST_EXPRCXX_H
