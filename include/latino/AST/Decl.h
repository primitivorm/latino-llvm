...
#ifndef LLVM_LATINO_AST_DECL_H
#define LLVM_LATINO_AST_DECL_H
...
//   StringRef getValue() const { return getTrailingObjects<char>() +
//   ValueStart; }
...
public:
  ...
  Linkage getFormalLinkage() const {
    return latino::getFormalLinkage(getLinkageInternal());
  }
  ...
  bool isExternallyVisible() const {
    return latino::isExternallyVisible(getLinkageInternal());
  }
