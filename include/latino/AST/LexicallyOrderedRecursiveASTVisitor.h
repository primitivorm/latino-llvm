...
#ifndef LLVM_LATINO_AST_LEXICALLY_ORDERED_RECURSIVEASTVISITOR_H
#define LLVM_LATINO_AST_LEXICALLY_ORDERED_RECURSIVEASTVISITOR_H
...
#endif // LLVM_LATINO_AST_LEXICALLY_ORDERED_RECURSIVEASTVISITOR_H
