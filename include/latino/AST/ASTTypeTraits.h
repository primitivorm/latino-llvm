...
#ifndef LLVM_LATINO_AST_ASTTYPETRAITS_H
#define LLVM_LATINO_AST_ASTTYPETRAITS_H
...
// Previously these types were defined in the latino::ast_type_traits namespace.
// Provide typedefs so that legacy code can be fixed asynchronously.
namespace ast_type_traits {
using DynTypedNode = ::latino::DynTypedNode;
using ASTNodeKind = ::latino::ASTNodeKind;
using TraversalKind = ::latino::TraversalKind;

constexpr TraversalKind TK_AsIs = ::latino::TK_AsIs;
constexpr TraversalKind TK_IgnoreImplicitCastsAndParentheses =
    ::latino::TK_IgnoreImplicitCastsAndParentheses;
constexpr TraversalKind TK_IgnoreUnlessSpelledInSource =
    ::latino::TK_IgnoreUnlessSpelledInSource;
} // namespace ast_type_traits
...
template <>
struct DenseMapInfo<latino::ASTNodeKind> : latino::ASTNodeKind::DenseMapInfo {};

template <>
struct DenseMapInfo<latino::DynTypedNode> : latino::DynTypedNode::DenseMapInfo {};
