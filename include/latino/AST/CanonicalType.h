...
#ifndef LLVM_LATINO_AST_CANONICALTYPE_H
#define LLVM_LATINO_AST_CANONICALTYPE_H
...
#define LLVM_LATINO_CANPROXY_TYPE_ACCESSOR(Accessor)                    \
CanQualType Accessor() const {                                           \
return CanQualType::CreateUnsafe(this->getTypePtr()->Accessor());      \
}

#define LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(Type, Accessor)             \
...
public:
  ...
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(Type::TypeClass, getTypeClass)

  // Type predicates
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isObjectType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isIncompleteType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isSizelessType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isSizelessBuiltinType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isIncompleteOrObjectType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isVariablyModifiedType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isIntegerType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isEnumeralType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isBooleanType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isCharType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isWideCharType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isIntegralType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isIntegralOrEnumerationType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isRealFloatingType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isComplexType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isAnyComplexType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isFloatingType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isRealType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isArithmeticType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isVoidType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isDerivedType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isScalarType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isAggregateType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isAnyPointerType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isVoidPointerType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isFunctionPointerType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isMemberFunctionPointerType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isClassType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isStructureType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isInterfaceType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isStructureOrClassType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isUnionType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isComplexIntegerType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isNullPtrType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isDependentType)
  ...
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, hasFloatingRepresentation)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isPromotableIntegerType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isSignedIntegerType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isUnsignedIntegerType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isSignedIntegerOrEnumerationType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isUnsignedIntegerOrEnumerationType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isConstantSizeType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isSpecifierType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(CXXRecordDecl*, getAsCXXRecordDecl)
...
template<typename T>
struct simplify_type< ::latino::CanQual<T>> {
  using SimpleType = const T *;

  static SimpleType getSimplifiedValue(::latino::CanQual<T> Val) {
...
template<typename T>
struct PointerLikeTypeTraits<latino::CanQual<T>> {
  static void *getAsVoidPointer(latino::CanQual<T> P) {
    return P.getAsOpaquePtr();
  }

  static latino::CanQual<T> getFromVoidPointer(void *P) {
    return latino::CanQual<T>::getFromOpaquePtr(P);
  }
...
struct CanProxyAdaptor<ComplexType> : public CanProxyBase<ComplexType> {
  LLVM_LATINO_CANPROXY_TYPE_ACCESSOR(getElementType)
};
...
struct CanProxyAdaptor<MemberPointerType>
  ...
  LLVM_LATINO_CANPROXY_TYPE_ACCESSOR(getPointeeType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(const Type *, getClass)
};
...
struct CanProxyAdaptor<DependentSizedExtVectorType>
  ...
  LLVM_LATINO_CANPROXY_TYPE_ACCESSOR(getElementType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(const Expr *, getSizeExpr)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(SourceLocation, getAttributeLoc)
};

template<>
struct CanProxyAdaptor<VectorType> : public CanProxyBase<VectorType> {
  LLVM_LATINO_CANPROXY_TYPE_ACCESSOR(getElementType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(unsigned, getNumElements)
};
...
struct CanProxyAdaptor<FunctionType> : public CanProxyBase<FunctionType> {
  LLVM_LATINO_CANPROXY_TYPE_ACCESSOR(getReturnType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(FunctionType::ExtInfo, getExtInfo)
};
...
struct CanProxyAdaptor<FunctionProtoType>
  ...
  LLVM_LATINO_CANPROXY_TYPE_ACCESSOR(getReturnType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(FunctionType::ExtInfo, getExtInfo)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(unsigned, getNumParams)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, hasExtParameterInfos)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(
  ...
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isVariadic)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(Qualifiers, getMethodQuals)
...
struct CanProxyAdaptor<TypeOfType> : public CanProxyBase<TypeOfType> {
  LLVM_LATINO_CANPROXY_TYPE_ACCESSOR(getUnderlyingType)
};

template<>
struct CanProxyAdaptor<DecltypeType> : public CanProxyBase<DecltypeType> {
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(Expr *, getUnderlyingExpr)
  LLVM_LATINO_CANPROXY_TYPE_ACCESSOR(getUnderlyingType)
};
...
struct CanProxyAdaptor<UnaryTransformType>
  ...
  LLVM_LATINO_CANPROXY_TYPE_ACCESSOR(getUnderlyingType)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(UnaryTransformType::UTTKind, getUTTKind)
};

template<>
struct CanProxyAdaptor<TagType> : public CanProxyBase<TagType> {
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(TagDecl *, getDecl)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isBeingDefined)
};

template<>
struct CanProxyAdaptor<RecordType> : public CanProxyBase<RecordType> {
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(RecordDecl *, getDecl)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isBeingDefined)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, hasConstFields)
};

template<>
struct CanProxyAdaptor<EnumType> : public CanProxyBase<EnumType> {
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(EnumDecl *, getDecl)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isBeingDefined)
};
...
struct CanProxyAdaptor<TemplateTypeParmType>
  ...
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(unsigned, getDepth)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(unsigned, getIndex)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(bool, isParameterPack)
  LLVM_LATINO_CANPROXY_SIMPLE_ACCESSOR(TemplateTypeParmDecl *, getDecl)
...
#endif // LLVM_LATINO_AST_CANONICALTYPE_H
