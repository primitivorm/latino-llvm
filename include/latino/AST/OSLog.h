...
#ifndef LLVM_LATINO_ANALYSIS_ANALYSES_OSLOG_H
#define LLVM_LATINO_ANALYSIS_ANALYSES_OSLOG_H
...
bool computeOSLogBufferLayout(latino::ASTContext &Ctx, const latino::CallExpr *E,
