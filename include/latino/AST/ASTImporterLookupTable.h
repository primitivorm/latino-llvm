...
#ifndef LLVM_LATINO_AST_ASTIMPORTERLOOKUPTABLE_H
#define LLVM_LATINO_AST_ASTIMPORTERLOOKUPTABLE_H

#include "latino/AST/DeclBase.h" // lookup_result
...
#endif // LLVM_LATINO_AST_ASTIMPORTERLOOKUPTABLE_H
