...
#ifndef LLVM_LATINO_AST_CHARUNITS_H
#define LLVM_LATINO_AST_CHARUNITS_H
...
inline latino::CharUnits operator* (latino::CharUnits::QuantityType Scale,
                                   const latino::CharUnits &CU) {
  return CU * Scale;
}

namespace llvm {

template<> struct DenseMapInfo<latino::CharUnits> {
  static latino::CharUnits getEmptyKey() {
    latino::CharUnits::QuantityType Quantity =
      DenseMapInfo<latino::CharUnits::QuantityType>::getEmptyKey();

    return latino::CharUnits::fromQuantity(Quantity);
  }

  static latino::CharUnits getTombstoneKey() {
    latino::CharUnits::QuantityType Quantity =
      DenseMapInfo<latino::CharUnits::QuantityType>::getTombstoneKey();

    return latino::CharUnits::fromQuantity(Quantity);
  }

  static unsigned getHashValue(const latino::CharUnits &CU) {
    latino::CharUnits::QuantityType Quantity = CU.getQuantity();
    return DenseMapInfo<latino::CharUnits::QuantityType>::getHashValue(Quantity);
  }

  static bool isEqual(const latino::CharUnits &LHS,
                      const latino::CharUnits &RHS) {
    return LHS == RHS;
  }
};
...
#endif // LLVM_LATINO_AST_CHARUNITS_H
