...
#ifndef LLVM_LATINO_AST_DECLARATIONNAME_H
#define LLVM_LATINO_AST_DECLARATIONNAME_H
...
struct DenseMapInfo<latino::DeclarationName> {
  ...
  static inline latino::DeclarationName getTombstoneKey() {
    return latino::DeclarationName::getTombstoneMarker();
  }
