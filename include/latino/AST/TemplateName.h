...
#ifndef LLVM_LATINO_AST_TEMPLATENAME_H
#define LLVM_LATINO_AST_TEMPLATENAME_H
...
struct PointerLikeTypeTraits<latino::TemplateName> {
  ...
  static inline latino::TemplateName getFromVoidPointer(void *Ptr) {
    return latino::TemplateName::getFromVoidPointer(Ptr);
  }
...
#endif // LLVM_LATINO_AST_TEMPLATENAME_H
