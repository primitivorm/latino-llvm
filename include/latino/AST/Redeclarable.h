...
#ifndef LLVM_LATINO_AST_REDECLARABLE_H
#define LLVM_LATINO_AST_REDECLARABLE_H
...
template <typename decl_type>
struct DenseMapInfo<latino::CanonicalDeclPtr<decl_type>> {
  using CanonicalDeclPtr = latino::CanonicalDeclPtr<decl_type>;
...
#endif // LLVM_LATINO_AST_REDECLARABLE_H
