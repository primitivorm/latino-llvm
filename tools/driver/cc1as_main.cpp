...
//===----------------------------------------------------------------------===//
//
// This is the entry point to the latino -cc1as functionality, which implements
...
using namespace latino::driver::options;
...
static bool ExecuteAssembler(AssemblerInvocation &Opts,
  ...
  // When -fembed-bitcode is passed to latino_as, a 1-byte marker
...
int cc1as_main(ArrayRef<const char *> Argv, const char *Argv0, void *MainAddr) {
  ...
  DiagClient->setPrefix("latino -cc1as");
  ...
  if (Asm.ShowHelp) {
    getDriverOptTable().PrintHelp(
        llvm::outs(), "latino -cc1as [options] file...",
  ...
  if (!Asm.LLVMArgs.empty()) {
    ...
    Args[0] = "latino (LLVM option parsing)";
