...
#include "latino/Basic/DebugInfoOptions.h"
...
#include "latino/Frontend/CommandLineSourceLoc.h"
...
#include "latino/Frontend/FrontendPluginRegistry.h"
...
#include "latino/Sema/CodeCompleteOptions.h"
...
#include "latino/StaticAnalyzer/Core/AnalyzerOptions.def"
...
bool latino::ParseDiagnosticArgs(DiagnosticOptions &Opts, ArgList &Args,
                                DiagnosticsEngine *Diags,
...
#include "latino/Basic/LangStandards.def"
          Diag << NumAliases;
#define LANGSTANDARD(id, name, lang, desc, features)
#define LANGSTANDARD_ALIAS(id, alias) \
...
#include "latino/Basic/LangStandards.def"
  ...
  if (Arg *A = Args.getLastArg(OPT_fclang_abi_compat_EQ)) {
    ...
    if (!VerParts.first.startswith("0") &&
        ...
        3 <= Major && Major <= LATINO_VERSION_MAJOR &&
