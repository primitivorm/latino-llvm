...
#include "latino/Frontend/DiagnosticRenderer.h"
#include "latino/Frontend/FrontendDiagnostic.h"
#include "latino/Frontend/SerializedDiagnosticReader.h"
#include "latino/Frontend/SerializedDiagnostics.h"
...
using namespace latino::serialized_diags;
...
void SDiagsRenderer::emitDiagnosticMessage(
    ...
    StringRef Message, ArrayRef<latino::CharSourceRange> Ranges,
    DiagOrStoredDiag D) {
