...
//===----------------------------------------------------------------------===//
//
// This file implements the latino::InitializePreprocessor function.
//
//===----------------------------------------------------------------------===//
...
#define TOSTR(X) TOSTR2(X)
  Builder.defineMacro("__clang_major__", TOSTR(LATINO_VERSION_MAJOR));
  Builder.defineMacro("__clang_minor__", TOSTR(LATINO_VERSION_MINOR));
  Builder.defineMacro("__clang_patchlevel__", TOSTR(LATINO_VERSION_PATCHLEVEL));
#undef TOSTR
#undef TOSTR2
...
///
void latino::InitializePreprocessor(
