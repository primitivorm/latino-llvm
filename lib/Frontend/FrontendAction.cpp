...
#include "latino/Frontend/LayoutOverrideSource.h"
#include "latino/Frontend/MultiplexConsumer.h"
...
static std::error_code collectModuleHeaderIncludes(
    ...
    ModuleMap &ModMap, latino::Module *Module, SmallVectorImpl<char> &Includes) {
  ...
  for (latino::Module::submodule_iterator Sub = Module->submodule_begin(),
