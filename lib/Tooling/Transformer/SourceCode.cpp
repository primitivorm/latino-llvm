...
StringRef latino::tooling::getText(CharSourceRange Range,
                                  const ASTContext &Context) {
  return Lexer::getSourceText(Range, Context.getSourceManager(),
                              Context.getLangOpts());
}

CharSourceRange latino::tooling::maybeExtendRange(CharSourceRange Range,
                                                 tok::TokenKind Next,
                                                 ASTContext &Context) {
...
llvm::Error latino::tooling::validateEditRange(const CharSourceRange &Range,
...
latino::tooling::getRangeForEdit(const CharSourceRange &EditRange,
                                const SourceManager &SM,
...
getEntityEndLoc(const SourceManager &SM, SourceLocation EntityLast,
  ...
  std::unique_ptr<Lexer> Lexer = [&]() {
    ...
    return std::make_unique<latino::Lexer>(
