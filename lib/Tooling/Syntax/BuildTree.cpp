...
static bool isImplicitExpr(latino::Expr *E) { return E->IgnoreImplicit() != E; }
...
public:
  ...
  /// When called on expressions (latino::Expr is derived from latino::Stmt),
  ...
  llvm::ArrayRef<syntax::Token> getDeclarationRange(Decl *D) {
    llvm::ArrayRef<latino::syntax::Token> Tokens;
...
public:
  ...
  buildUserDefinedLiteral(UserDefinedLiteral *S) {
    ...
    case latino::UserDefinedLiteral::LOK_Integer:
      return new (allocator()) syntax::IntegerUserDefinedLiteralExpression;
    case latino::UserDefinedLiteral::LOK_Floating:
      return new (allocator()) syntax::FloatUserDefinedLiteralExpression;
    case latino::UserDefinedLiteral::LOK_Character:
      return new (allocator()) syntax::CharUserDefinedLiteralExpression;
    case latino::UserDefinedLiteral::LOK_String:
      return new (allocator()) syntax::StringUserDefinedLiteralExpression;
    case latino::UserDefinedLiteral::LOK_Raw:
    case latino::UserDefinedLiteral::LOK_Template:
  ...
  // Declarator chunks, they are produced by type locs and some latino::Decls.
