...
#ifndef LLVM_LATINO_LIB_ASTMATCHERS_DYNAMIC_MARSHALLERS_H
#define LLVM_LATINO_LIB_ASTMATCHERS_DYNAMIC_MARSHALLERS_H
...
#include "latino/AST/OperationKinds.def"
        .Default(llvm::None);
  }
...
#endif // LLVM_LATINO_AST_MATCHERS_DYNAMIC_MARSHALLERS_H
