...
#ifndef LLVM_LATINO_LIB_DRIVER_TOOLCHAINS_CLOUDABI_H
#define LLVM_LATINO_LIB_DRIVER_TOOLCHAINS_CLOUDABI_H
...
#endif // LLVM_LATINO_LIB_DRIVER_TOOLCHAINS_CLOUDABI_H
