...
RocmInstallationDetector::RocmInstallationDetector(
    ...
    : D(D) {
  RocmPathArg = Args.getLastArgValue(latino::driver::options::OPT_rocm_path_EQ);
  RocmDeviceLibPathArg =
      Args.getAllArgValues(latino::driver::options::OPT_rocm_device_lib_path_EQ);
  if (auto *A = Args.getLastArg(latino::driver::options::OPT_hip_version_EQ)) {
