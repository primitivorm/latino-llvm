...
CudaInstallationDetector::CudaInstallationDetector(
  ...
  if (Args.hasArg(latino::driver::options::OPT_cuda_path_EQ)) {
    Candidates.emplace_back(
        Args.getLastArgValue(latino::driver::options::OPT_cuda_path_EQ).str());
    ...
    if (!Args.hasArg(latino::driver::options::OPT_cuda_path_ignore_env)) {
