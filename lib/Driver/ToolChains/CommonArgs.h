...
#ifndef LLVM_LATINO_LIB_DRIVER_TOOLCHAINS_COMMONARGS_H
#define LLVM_LATINO_LIB_DRIVER_TOOLCHAINS_COMMONARGS_H
...
#endif // LLVM_LATINO_LIB_DRIVER_TOOLCHAINS_COMMONARGS_H
