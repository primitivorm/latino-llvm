//===--- Latino.h - Clang Tool and ToolChain Implementations ====-*- C++ -*-===//
//
...
#ifndef LLVM_LATINO_LIB_DRIVER_TOOLCHAINS_Clang_H
#define LLVM_LATINO_LIB_DRIVER_TOOLCHAINS_Clang_H
...
public:
  ClangAs(const ToolChain &TC)
      : Tool("latino::as", "clang integrated assembler", TC) {}
  void AddMIPSTargetArgs(const llvm::opt::ArgList &Args,
                         llvm::opt::ArgStringList &CmdArgs) const;
  void AddX86TargetArgs(const llvm::opt::ArgList &Args,
                        llvm::opt::ArgStringList &CmdArgs) const;
...
#endif // LLVM_LATINO_LIB_DRIVER_TOOLCHAINS_CLANG_H
