...
void x86::getX86TargetFeatures(const Driver &D, const llvm::Triple &Triple,
  ...
  auto SpectreOpt = latino::driver::options::ID::OPT_INVALID;
  ...
  auto LVIOpt = latino::driver::options::ID::OPT_INVALID;
  ...
  if (Args.hasFlag(options::OPT_m_seses, options::OPT_mno_seses, false)) {
    ...
    if (SpectreOpt != latino::driver::options::ID::OPT_INVALID)
      D.Diag(diag::err_drv_argument_not_allowed_with)
  ...
  if (SpectreOpt != latino::driver::options::ID::OPT_INVALID &&
      LVIOpt != latino::driver::options::ID::OPT_INVALID) {
    D.Diag(diag::err_drv_argument_not_allowed_with)
        << D.getOpts().getOptionName(SpectreOpt)
