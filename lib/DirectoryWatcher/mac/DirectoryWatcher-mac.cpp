...
class DirectoryWatcherMac : public latino::DirectoryWatcher {
public:
  DirectoryWatcherMac(
...
llvm::Expected<std::unique_ptr<DirectoryWatcher>> latino::DirectoryWatcher::create(
    StringRef Path,
    std::function<void(llvm::ArrayRef<DirectoryWatcher::Event>, bool)> Receiver,
...
latino::DirectoryWatcher::create(
    StringRef Path,
    std::function<void(llvm::ArrayRef<DirectoryWatcher::Event>, bool)> Receiver,
    bool WaitForInitialSync) {
