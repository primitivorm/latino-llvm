...
#ifndef LLVM_LATINO_LIB_CODEGEN_CODEGENTBAA_H
#define LLVM_LATINO_LIB_CODEGEN_CODEGENTBAA_H
...
class CodeGenTBAA {
  ...
  /// MetadataCache - This maps latino::Types to scalar llvm::MDNodes describing
  /// them.
  llvm::DenseMap<const Type *, llvm::MDNode *> MetadataCache;
  /// This maps latino::Types to a base access type in the type DAG.
  ...
  /// StructMetadataCache - This maps latino::Types to llvm::MDNodes describing
...
template<> struct DenseMapInfo<latino::CodeGen::TBAAAccessInfo> {
  static latino::CodeGen::TBAAAccessInfo getEmptyKey() {
    unsigned UnsignedKey = DenseMapInfo<unsigned>::getEmptyKey();
    return latino::CodeGen::TBAAAccessInfo(
      static_cast<latino::CodeGen::TBAAAccessKind>(UnsignedKey),
  ...
  static latino::CodeGen::TBAAAccessInfo getTombstoneKey() {
  ...
  static unsigned getHashValue(const latino::CodeGen::TBAAAccessInfo &Val) {
  ...
  static bool isEqual(const latino::CodeGen::TBAAAccessInfo &LHS,
                      const latino::CodeGen::TBAAAccessInfo &RHS) {
    return LHS == RHS;
  }
};
