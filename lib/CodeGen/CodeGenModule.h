...
#ifndef LLVM_LATINO_LIB_CODEGEN_CODEGENMODULE_H
#define LLVM_LATINO_LIB_CODEGEN_CODEGENMODULE_H
...
private:
  ...
  llvm::SetVector<latino::Module *> ImportedModules;

  /// The set of modules for which the module initializers
  /// have been emitted.
  llvm::SmallPtrSet<latino::Module *, 16> EmittedModuleInitializers;
...
#endif // LLVM_LATINO_LIB_CODEGEN_CODEGENMODULE_H
