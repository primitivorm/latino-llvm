...
#ifndef LLVM_LATINO_LIB_CODEGEN_CGLOOPINFO_H
#define LLVM_LATINO_LIB_CODEGEN_CGLOOPINFO_H
...
public:
  ...
  void push(llvm::BasicBlock *Header, latino::ASTContext &Ctx,
            const latino::CodeGenOptions &CGOpts,
