...
getIntegerWidthAndSignedness(const latino::ASTContext &context,
                             const latino::QualType Type) {
...
static RValue
EmitCheckedMixedSignMultiply(CodeGenFunction &CGF, const latino::Expr *Op1,
                             WidthAndSignedness Op1Info, const latino::Expr *Op2,
                             WidthAndSignedness Op2Info,
                             const latino::Expr *ResultArg, QualType ResultQTy,
                             WidthAndSignedness ResultInfo) {
  ...
  const latino::Expr *SignedOp = Op1Info.Signed ? Op1 : Op2;
  const latino::Expr *UnsignedOp = Op1Info.Signed ? Op2 : Op1;
...
RValue CodeGenFunction::EmitBuiltinExpr(const GlobalDecl GD, unsigned BuiltinID,
  ...
  case Builtin::BI__builtin_mul_overflow: {
    const latino::Expr *LeftArg = E->getArg(0);
    const latino::Expr *RightArg = E->getArg(1);
    const latino::Expr *ResultArg = E->getArg(2);

    latino::QualType ResultQTy =
...
#include "latino/Basic/arm_sve_builtin_cg.inc"
...
static Value *EmitSpecialRegisterBuiltin(CodeGenFunction &CGF,
  ...
  if (SysReg.empty()) {
    ...
    SysReg = cast<latino::StringLiteral>(SysRegStrExpr)->getString();
  }
...
static bool HasExtraNeonArgument(unsigned BuiltinID) {
  ...
  case latino::ARM::BI_MoveToCoprocessor:
  case latino::ARM::BI_MoveToCoprocessor2:
    return false;
  }
  return true;
}
...
Value *CodeGenFunction::EmitARMMVEBuiltinExpr(unsigned BuiltinID,
  ...
  switch (BuiltinID) {
    #include "latino/Basic/arm_mve_builtin_cg.inc"
...
Value *CodeGenFunction::EmitARMCDEBuiltinExpr(unsigned BuiltinID,
  ...
  default:
    return nullptr;
#include "latino/Basic/arm_cde_builtin_cg.inc"
  }
}
...
static Value *EmitX86FMAExpr(CodeGenFunction &CGF, ArrayRef<Value *> Ops,
  ...
  switch (BuiltinID) {
  default: break;
  case latino::X86::BI__builtin_ia32_vfmsubps512_mask3:
    Subtract = true;
    LLVM_FALLTHROUGH;
  case latino::X86::BI__builtin_ia32_vfmaddps512_mask:
  case latino::X86::BI__builtin_ia32_vfmaddps512_maskz:
  case latino::X86::BI__builtin_ia32_vfmaddps512_mask3:
    IID = llvm::Intrinsic::x86_avx512_vfmadd_ps_512; break;
  case latino::X86::BI__builtin_ia32_vfmsubpd512_mask3:
    Subtract = true;
    LLVM_FALLTHROUGH;
  case latino::X86::BI__builtin_ia32_vfmaddpd512_mask:
  case latino::X86::BI__builtin_ia32_vfmaddpd512_maskz:
  case latino::X86::BI__builtin_ia32_vfmaddpd512_mask3:
    IID = llvm::Intrinsic::x86_avx512_vfmadd_pd_512; break;
  case latino::X86::BI__builtin_ia32_vfmsubaddps512_mask3:
    Subtract = true;
    LLVM_FALLTHROUGH;
  case latino::X86::BI__builtin_ia32_vfmaddsubps512_mask:
  case latino::X86::BI__builtin_ia32_vfmaddsubps512_maskz:
  case latino::X86::BI__builtin_ia32_vfmaddsubps512_mask3:
    IID = llvm::Intrinsic::x86_avx512_vfmaddsub_ps_512;
    break;
  case latino::X86::BI__builtin_ia32_vfmsubaddpd512_mask3:
    Subtract = true;
    LLVM_FALLTHROUGH;
  case latino::X86::BI__builtin_ia32_vfmaddsubpd512_mask:
  case latino::X86::BI__builtin_ia32_vfmaddsubpd512_maskz:
  case latino::X86::BI__builtin_ia32_vfmaddsubpd512_mask3:
...
Value *CodeGenFunction::EmitX86CpuIs(const CallExpr *E) {
  ...
  StringRef CPUStr = cast<latino::StringLiteral>(CPUExpr)->getString();
...
#include "latino/Basic/BuiltinsHexagonMapCustomDep.def"
