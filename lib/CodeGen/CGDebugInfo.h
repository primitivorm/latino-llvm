...
#ifndef LLVM_LATINO_LIB_CODEGEN_CGDEBUGINFO_H
#define LLVM_LATINO_LIB_CODEGEN_CGDEBUGINFO_H
...
// #include "latino/Basic/OpenCLExtensionTypes.def"
  ...
  class PrintingCallbacks final : public latino::PrintingCallbacks {
...
#endif // LLVM_LATINO_LIB_CODEGEN_CGDEBUGINFO_H
