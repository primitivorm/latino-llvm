...
#ifndef LLVM_LATINO_LIB_CODEGEN_CGOPENMPRUNTIMENVPTX_H
#define LLVM_LATINO_LIB_CODEGEN_CGOPENMPRUNTIMENVPTX_H
...
#endif // LLVM_LATINO_LIB_CODEGEN_CGOPENMPRUNTIMENVPTX_H
