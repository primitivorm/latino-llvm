...
class EmitAssemblyHelper {
  ...
  const latino::TargetOptions &TargetOpts;
...
public:
  EmitAssemblyHelper(DiagnosticsEngine &_Diags,
                     ...
                     const latino::TargetOptions &TOpts,
...
Expected<BitcodeModule> latino::FindThinLTOModule(MemoryBufferRef MBRef) {
...
BitcodeModule *latino::FindThinLTOModule(MutableArrayRef<BitcodeModule> BMs) {
...
static void runThinLTOBackend(
    ...
    const latino::TargetOptions &TOpts, const LangOptions &LOpts,
...
void latino::EmitBackendOutput(DiagnosticsEngine &Diags,
...
void latino::EmbedBitcode(llvm::Module *M, const CodeGenOptions &CGOpts,
