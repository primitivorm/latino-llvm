...
#ifndef LLVM_LATINO_LIB_FORMAT_TOKENANALYZER_H
#define LLVM_LATINO_LIB_FORMAT_TOKENANALYZER_H
...
public:
  ...
  // See also the documentation of latino::format::internal::reformat.
