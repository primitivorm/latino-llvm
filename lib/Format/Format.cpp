...
#include "latino/Tooling/Inclusions/HeaderIncludes.h"
...
using latino::format::FormatStyle;

LLVM_YAML_IS_SEQUENCE_VECTOR(latino::format::FormatStyle::RawStringFormat)
