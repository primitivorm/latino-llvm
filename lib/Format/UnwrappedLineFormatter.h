...
#ifndef LLVM_LATINO_LIB_FORMAT_UNWRAPPEDLINEFORMATTER_H
#define LLVM_LATINO_LIB_FORMAT_UNWRAPPEDLINEFORMATTER_H
...
#endif // LLVM_LATINO_LIB_FORMAT_UNWRAPPEDLINEFORMATTER_H
