...
#ifndef LLVM_LATINO_LIB_FORMAT_AFFECTEDRANGEMANAGER_H
#define LLVM_LATINO_LIB_FORMAT_AFFECTEDRANGEMANAGER_H
...
#endif // LLVM_LATINO_LIB_FORMAT_AFFECTEDRANGEMANAGER_H
