...
#ifndef LLVM_LATINO_STATICANALYZER_UNINITIALIZEDOBJECT_H
#define LLVM_LATINO_STATICANALYZER_UNINITIALIZEDOBJECT_H
...
#endif // LLVM_LATINO_STATICANALYZER_UNINITIALIZEDOBJECT_H
