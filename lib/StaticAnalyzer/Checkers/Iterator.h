...
#ifndef LLVM_LATINO_LIB_STATICANALYZER_CHECKERS_ITERATOR_H
#define LLVM_LATINO_LIB_STATICANALYZER_CHECKERS_ITERATOR_H
...
using IteratorSymbolMapTy =
  LATINO_ENTO_PROGRAMSTATE_MAP(SymbolRef, IteratorPosition);
using IteratorRegionMapTy =
  LATINO_ENTO_PROGRAMSTATE_MAP(const MemRegion *, IteratorPosition);
using ContainerMapTy =
  LATINO_ENTO_PROGRAMSTATE_MAP(const MemRegion *, ContainerData);
