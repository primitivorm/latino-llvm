...
void latino::ento::registerMPIChecker(CheckerManager &MGR) {
  MGR.registerChecker<latino::ento::mpi::MPIChecker>();
}

bool latino::ento::shouldRegisterMPIChecker(const CheckerManager &mgr) {
  return true;
}
