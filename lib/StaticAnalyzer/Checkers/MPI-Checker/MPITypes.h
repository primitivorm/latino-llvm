...
#ifndef LLVM_LATINO_LIB_STATICANALYZER_CHECKERS_MPICHECKER_MPITYPES_H
#define LLVM_LATINO_LIB_STATICANALYZER_CHECKERS_MPICHECKER_MPITYPES_H
...
struct RequestMap {};
typedef llvm::ImmutableMap<const latino::ento::MemRegion *,
                           latino::ento::mpi::Request>
    RequestMapImpl;
