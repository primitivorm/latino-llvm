...
REGISTER_MAP_WITH_PROGRAMSTATE(DynamicTypeMap, const latino::ento::MemRegion *,
                               latino::ento::DynamicTypeInfo)

/// A set factory of dynamic cast informations.
REGISTER_SET_FACTORY_WITH_PROGRAMSTATE(CastSet, latino::ento::DynamicCastInfo)

/// A map from symbols to cast informations.
REGISTER_MAP_WITH_PROGRAMSTATE(DynamicCastMap, const latino::ento::MemRegion *,
                               CastSet)

// A map from Class object symbols to the most likely pointed-to type.
REGISTER_MAP_WITH_PROGRAMSTATE(DynamicClassObjectMap, latino::ento::SymbolRef,
                               latino::ento::DynamicTypeInfo)
