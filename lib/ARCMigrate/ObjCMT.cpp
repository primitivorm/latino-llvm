...
#include "latino/ARCMigrate/ARCMTActions.h"
...
#include "latino/Edit/Commit.h"
#include "latino/Edit/EditedSource.h"
#include "latino/Edit/EditsReceiver.h"
#include "latino/Edit/Rewriters.h"
...
void ObjCMigrateASTConsumer::AddCFAnnotations(ASTContext &Ctx,
  ...
  if (!ResultAnnotated) {
    ...
    if (Ret.getObjKind() == ObjKind::CF) {
      ...
      switch (OMF) {
        case latino::OMF_alloc:
        case latino::OMF_new:
        case latino::OMF_copy:
        case latino::OMF_init:
        case latino::OMF_mutableCopy:
          break;
