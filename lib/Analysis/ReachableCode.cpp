...
namespace {
  ...
  public:
    ...
    latino::reachable_code::Callback &CB);
...
bool DeadCodeScan::isDeadCodeRoot(const latino::CFGBlock *Block) {
...
const Stmt *DeadCodeScan::findDeadCode(const latino::CFGBlock *Block) {
...
unsigned DeadCodeScan::scanBackwards(const latino::CFGBlock *Start,
                                     latino::reachable_code::Callback &CB) {
...
namespace latino { namespace reachable_code {
