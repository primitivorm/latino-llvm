...
using latino::analyze_scanf::ScanfConversionSpecifier;
using latino::analyze_scanf::ScanfSpecifier;
using latino::UpdateOnReturn;
using namespace latino;

typedef latino::analyze_format_string::SpecifierResult<ScanfSpecifier>
...
static ScanfSpecifierResult ParseScanfSpecifier(FormatStringHandler &H,
  ...
  using namespace latino::analyze_scanf;
  const char *I = Beg;
  ...
  const OptionalAmount &Amt = latino::analyze_format_string::ParseAmount(I, E);
...
bool latino::analyze_format_string::ParseScanfString(FormatStringHandler &H,
                                                    const char *I,
                                                    const char *E,
                                                    const LangOptions &LO,
                                                    const TargetInfo &Target) {
