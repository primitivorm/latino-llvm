...
using latino::analyze_format_string::FormatSpecifier;
using latino::analyze_format_string::LengthModifier;
using latino::analyze_format_string::OptionalAmount;
using latino::analyze_format_string::PositionContext;
...
OptionalAmount
latino::analyze_format_string::ParseAmount(const char *&Beg, const char *E) {
  const char *I = Beg;
...
OptionalAmount
latino::analyze_format_string::ParseNonPositionAmount(const char *&Beg,
                                                     const char *E,
                                                     unsigned &argIndex) {
  if (*Beg == '*') {
    ++Beg;
...
OptionalAmount
latino::analyze_format_string::ParsePositionAmount(FormatStringHandler &H,
                                                  const char *Start,
                                                  const char *&Beg,
                                                  const char *E,
                                                  PositionContext p) {
...
bool
latino::analyze_format_string::ParseFieldWidth(FormatStringHandler &H,
                                              FormatSpecifier &CS,
                                              const char *Start,
...
bool
latino::analyze_format_string::ParseArgPosition(FormatStringHandler &H,
                                               FormatSpecifier &FS,
                                               const char *Start,
                                               const char *&Beg,
                                               const char *E) {
...
bool
latino::analyze_format_string::ParseVectorModifier(FormatStringHandler &H,
                                                  FormatSpecifier &FS,
                                                  const char *&I,
                                                  const char *E,
...
bool
latino::analyze_format_string::ParseLengthModifier(FormatSpecifier &FS,
                                                  const char *&I,
                                                  const char *E,
                                                  const LangOptions &LO,
                                                  bool IsScanf) {
...
bool latino::analyze_format_string::ParseUTF8InvalidSpecifier(
...
latino::analyze_format_string::ArgType::MatchKind
