...
using latino::analyze_format_string::ArgType;
using latino::analyze_format_string::FormatStringHandler;
using latino::analyze_format_string::LengthModifier;
using latino::analyze_format_string::OptionalAmount;
using latino::analyze_format_string::ConversionSpecifier;
using latino::analyze_printf::PrintfSpecifier;

using namespace latino;

typedef latino::analyze_format_string::SpecifierResult<PrintfSpecifier>
...
static PrintfSpecifierResult ParsePrintfSpecifier(FormatStringHandler &H,
  ...
  using namespace latino::analyze_format_string;
  using namespace latino::analyze_printf;
  ...
  if (*I == '{') {
    ...
    do {
      ...
      if (R.match(Str, &Matches)) {
        ...
        if (MatchedStr.startswith("mask")) {
          ...
          PrivacyFlags = latino::analyze_os_log::OSLogBufferItem::IsSensitive;
        else if (PrivacyFlags !=
                 latino::analyze_os_log::OSLogBufferItem::IsSensitive &&
                 MatchedStr.equals("private"))
          PrivacyFlags = latino::analyze_os_log::OSLogBufferItem::IsPrivate;
        else if (PrivacyFlags == 0 && MatchedStr.equals("public"))
          PrivacyFlags = latino::analyze_os_log::OSLogBufferItem::IsPublic;
      } else {
    ...
    case 0:
      break;
    case latino::analyze_os_log::OSLogBufferItem::IsPrivate:
      FS.setIsPrivate(MatchedStr.data());
      break;
    case latino::analyze_os_log::OSLogBufferItem::IsPublic:
      FS.setIsPublic(MatchedStr.data());
      break;
    case latino::analyze_os_log::OSLogBufferItem::IsSensitive:
...
bool latino::analyze_format_string::ParsePrintfString(FormatStringHandler &H,
                                                     const char *I,
                                                     const char *E,
                                                     const LangOptions &LO,
                                                     const TargetInfo &Target,
...
bool latino::analyze_format_string::ParseFormatStringHasSArg(const char *I,
                                                            const char *E,
                                                            const LangOptions &LO,
                                                            const TargetInfo &Target) {
...
bool latino::analyze_format_string::parseFormatStringHasFormattingSpecifiers(
  ...
  if (hasValidLengthModifier(Ctx.getTargetInfo(), LangOpt)) {
    ...
    case ConversionSpecifier::UArg:
      if (QT->isSignedIntegerType())
        CS.setKind(latino::analyze_format_string::ConversionSpecifier::dArg);
      break;
    case ConversionSpecifier::dArg:
    case ConversionSpecifier::DArg:
    case ConversionSpecifier::iArg:
      if (QT->isUnsignedIntegerType() && !HasPlusPrefix)
        CS.setKind(latino::analyze_format_string::ConversionSpecifier::uArg);
      break;
    default:
