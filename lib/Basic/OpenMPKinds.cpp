...
unsigned latino::getOpenMPSimpleClauseType(OpenMPClauseKind Kind,
                                          StringRef Str) {
  switch (Kind) {
  case OMPC_default:
...
#include "latino/Basic/OpenMPKinds.def"
...
const char *latino::getOpenMPSimpleClauseTypeName(OpenMPClauseKind Kind,
                                                 unsigned Type) {
  switch (Kind) {
  case OMPC_default:
...
bool latino::isOpenMPLoopDirective(OpenMPDirectiveKind DKind) {
...
bool latino::isOpenMPWorksharingDirective(OpenMPDirectiveKind DKind) {
...
bool latino::isOpenMPTaskLoopDirective(OpenMPDirectiveKind DKind) {
...
bool latino::isOpenMPParallelDirective(OpenMPDirectiveKind DKind) {
...
bool latino::isOpenMPTargetExecutionDirective(OpenMPDirectiveKind DKind) {
...
bool latino::isOpenMPTargetDataManagementDirective(OpenMPDirectiveKind DKind) {
  return DKind == OMPD_target_data || DKind == OMPD_target_enter_data ||
         DKind == OMPD_target_exit_data || DKind == OMPD_target_update;
}

bool latino::isOpenMPNestingTeamsDirective(OpenMPDirectiveKind DKind) {
...
bool latino::isOpenMPTeamsDirective(OpenMPDirectiveKind DKind) {
...
bool latino::isOpenMPSimdDirective(OpenMPDirectiveKind DKind) {
...
bool latino::isOpenMPNestingDistributeDirective(OpenMPDirectiveKind Kind) {
...
bool latino::isOpenMPDistributeDirective(OpenMPDirectiveKind Kind) {
...
bool latino::isOpenMPPrivate(OpenMPClauseKind Kind) {
...
bool latino::isOpenMPThreadPrivate(OpenMPClauseKind Kind) {
  return Kind == OMPC_threadprivate || Kind == OMPC_copyin;
}

bool latino::isOpenMPTaskingDirective(OpenMPDirectiveKind Kind) {
  return Kind == OMPD_task || isOpenMPTaskLoopDirective(Kind);
}

bool latino::isOpenMPLoopBoundSharingDirective(OpenMPDirectiveKind Kind) {
...
void latino::getOpenMPCaptureRegions(
