...
#include "latino/Analysis/Analyses/ThreadSafety.h"
#include "latino/Analysis/Analyses/UninitializedValues.h"
...
static void visitReachableThrows(
  ...
  latino::reachable_code::ScanReachableFromBlock(&BodyCFG->getEntry(), Reachable);
...
namespace {
class ThreadSafetyReporter : public latino::threadSafety::ThreadSafetyHandler {
  Sema &S;
  DiagList Warnings;
...
latino::sema::AnalysisBasedWarnings::Policy::Policy() {
...
latino::sema::AnalysisBasedWarnings::AnalysisBasedWarnings(Sema &s)
  : S(s),
...
void latino::sema::AnalysisBasedWarnings::PrintStats() const {
