...
#include "latino/Lex/HeaderSearch.h" // TODO: Sema shouldn't depend on Lex
#include "latino/Lex/Lexer.h" // TODO: Extract static functions to fix layering.
#include "latino/Lex/ModuleLoader.h" // TODO: Sema shouldn't depend on Lex
#include "latino/Lex/Preprocessor.h" // Included for isCodeCompletionEnabled()
#include "latino/Sema/CXXFieldCollector.h"
...
static void diagnoseMissingConstinit(Sema &S, const VarDecl *InitDecl,
  ...
  if (SuitableSpelling.empty() && S.getLangOpts().CPlusPlus11)
    SuitableSpelling = "[[latino::require_constant_initialization]]";
  if (SuitableSpelling.empty())
