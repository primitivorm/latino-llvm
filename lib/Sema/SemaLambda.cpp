...
getStackIndexOfNearestEnclosingCaptureReadyLambda(
    ArrayRef<const latino::sema::FunctionScopeInfo *> FunctionScopes,
  ...
  while (CurScopeIndex > 0 && isa<latino::sema::CapturedRegionScopeInfo>(
                                  FunctionScopes[CurScopeIndex]))
    --CurScopeIndex;
  assert(
      isa<latino::sema::LambdaScopeInfo>(FunctionScopes[CurScopeIndex]) &&
  ...
  do {
    const latino::sema::LambdaScopeInfo *LSI =
...
Optional<unsigned> latino::getStackIndexOfNearestEnclosingCaptureCapableLambda(
  ...
  if (IsCapturingVariable) {
    ...
    const bool CanCaptureVariable =
        !S.tryCaptureVariable(VarToCapture,
                              ...
                              latino::Sema::TryCapture_Implicit,
