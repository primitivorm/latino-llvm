...
ImplicitConversionRank latino::GetConversionRank(ImplicitConversionKind Kind) {
...
latino::MakeDeductionFailureInfo(ASTContext &Context,
...
bool latino::isBetterOverloadCandidate(
