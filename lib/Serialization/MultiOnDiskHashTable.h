...
#ifndef LLVM_LATINO_LIB_SERIALIZATION_MULTIONDISKHASHTABLE_H
#define LLVM_LATINO_LIB_SERIALIZATION_MULTIONDISKHASHTABLE_H
...
#endif // LLVM_LATINO_LIB_SERIALIZATION_MULTIONDISKHASHTABLE_H
