...
#ifndef LLVM_LATINO_LIB_SERIALIZATION_ASTREADERINTERNALS_H
#define LLVM_LATINO_LIB_SERIALIZATION_ASTREADERINTERNALS_H
...
#endif // LLVM_LATINO_LIB_SERIALIZATION_ASTREADERINTERNALS_H
