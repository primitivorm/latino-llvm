...
#include "latino/AST/AbstractTypeWriter.h"
...
#include "latino/Serialization/ASTRecordWriter.h"
...
void TypeLocWriter::VisitExtIntTypeLoc(latino::ExtIntTypeLoc TL) {
  Record.AddSourceLocation(TL.getNameLoc());
}
...
void ASTWriter::WriteControlBlock(Preprocessor &PP, ASTContext &Context,
         ...
         "writing module as a relocatable PCH?");
  {
    RecordData::value_type Record[] = {
        ...
        VERSION_MAJOR,
        VERSION_MINOR,
        LATINO_VERSION_MAJOR,
        LATINO_VERSION_MINOR,
        !isysroot.empty(),
        IncludeTimestamps,
...
void ASTRecordWriter::AddCXXDefinitionData(const CXXRecordDecl *D) {
  ...
  #include "latino/AST/CXXRecordDeclDefinitionBits.def"
