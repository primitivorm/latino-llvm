...
#ifndef LLVM_LATINO_UNITTESTS_ASTMATCHERS_ASTMATCHERSTEST_H
#define LLVM_LATINO_UNITTESTS_ASTMATCHERS_ASTMATCHERSTEST_H

#include "latino/ASTMatchers/ASTMatchFinder.h"
#include "latino/Frontend/ASTUnit.h"
#include "latino/Testing/CommandLineArgs.h"
#include "latino/Testing/TestClangConfig.h"
...
using latino::tooling::buildASTFromCodeWithArgs;
using latino::tooling::FileContentMappings;
using latino::tooling::FrontendActionFactory;
using latino::tooling::newFrontendActionFactory;
using latino::tooling::runToolOnCodeWithArgs;
...
protected:
  ...
  testing::AssertionResult matches(const Twine &Code, const T &AMatcher) {
    ...
    return latino::ast_matchers::matchesConditionally(
...
#endif // LLVM_LATINO_UNITTESTS_AST_MATCHERS_AST_MATCHERS_TEST_H
