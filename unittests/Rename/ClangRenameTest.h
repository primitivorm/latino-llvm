...
#ifndef LLVM_LATINO_UNITTESTS_RENAME_CLANGRENAMETEST_H
#define LLVM_LATINO_UNITTESTS_RENAME_CLANGRENAMETEST_H
...
protected:
  ...
  std::string runClangRenameOnCode(llvm::StringRef Code,
    ...
    tooling::FileContentMappings FileContents = {{HeaderName, HeaderContent},
                                                 {CCName, NewCode}};
    latino::RewriterTestContext Context;
    Context.createInMemoryFile(HeaderName, HeaderContent);
    latino::FileID InputFileID = Context.createInMemoryFile(CCName, NewCode);
