...
#include "latino/Tooling/AllTUsExecution.h"
#include "latino/Tooling/CompilationDatabase.h"
#include "latino/Tooling/StandaloneExecution.h"
#include "latino/Tooling/ToolExecutorPluginRegistry.h"
...
public:
  ...
  void HandleTranslationUnit(latino::ASTContext &Context) override {
    TraverseDecl(Context.getTranslationUnitDecl());
  }

  bool TraverseFunctionDecl(latino::FunctionDecl *Decl) {
...
protected:
  ...
  CreateASTConsumer(latino::CompilerInstance &compiler,
    ...
    std::unique_ptr<latino::ASTConsumer> ast_consumer{
