...
#ifndef LLVM_LATINO_UNITTESTS_TOOLING_REPLACEMENTTESTBASE_H
#define LLVM_LATINO_UNITTESTS_TOOLING_REPLACEMENTTESTBASE_H
...
#endif // LLVM_LATINO_UNITTESTS_TOOLING_REPLACEMENTTESTBASE_H
