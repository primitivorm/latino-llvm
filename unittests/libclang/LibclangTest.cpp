...
TEST_F(LiblatinoParseTest, AllSkippedRanges) {
...
TEST_F(LiblatinoParseTest, EvaluateChildExpression) {
...
class LibclangReparseTest : public LiblatinoParseTest {
public:
...
class LibclangPrintingPolicyTest : public LiblatinoParseTest {
public:
  CXPrintingPolicy Policy = nullptr;

  void SetUp() override {
    LiblatinoParseTest::SetUp();
...
class LiblatinoSerializationTest : public LiblatinoParseTest {
public:
...
TEST_F(LiblatinoSerializationTest, TokenKindsAreCorrectAfterLoading) {
